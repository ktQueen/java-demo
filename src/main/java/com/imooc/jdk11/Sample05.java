...
public class Sample05 {
    public static void main(String[] args) {
        ...
        String result3 = str.stripLeading();//去除首位空白
        System.out.println(str + "去除首位空白：" + result3.length());
